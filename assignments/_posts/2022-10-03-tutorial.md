...
show_date: false
---
**Complete by: Thursday 12 Oct. by 10:55am**
...
**Choose a single example data set** to work with, either something we've used for a previous workshop or the one you used for your documentation assignment. You can't choose one of the built-in Seaborn datasets: it should be something from an external CSV. *Make sure the data you choose is suitable for the technique you're explaining.*
