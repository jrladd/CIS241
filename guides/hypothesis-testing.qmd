...
6. Create a histogram that shows your permutation distribution and your observed statistic. This is a standard histogram or density plotplus a `plt.axvline()` layer that draws a vertical line for the observed statistic.
