...
permutations = permutations.assign(observed_difference=mean_difference) # Add the mean to the dataframe
# Add a vertical line
observed_difference = alt.Chart(permutations).mark_rule(color="red", strokeDash=(8,4)).encode(
